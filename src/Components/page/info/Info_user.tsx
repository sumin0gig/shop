...
const Info_user = () => {
	return (
		<div className='info_iframe'>
			<h4>서비스 이용약관</h4>
			<pre>{`제1조(목적)
이 약관은 ${siteName} 회사(전자상거래 사업자)가 운영하는 ${siteName} 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① "몰" 이란 ${siteName} 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제27조 카카오톡 알림톡, 상담톡 서비스 시행에 관한 이용약관
① 카카오톡 알림톡 시행에 관한 내용
...
①개인정보의 위탁 처리
 1."몰"은 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다.

제29조 할인쿠폰
①할인쿠폰은 ${siteName}가 무상으로 발행하는 쿠폰으로 발행대상, 발행경로, 사용대상 등에 따라 구분될 수 있으며, 회원의 구매횟수, 구매금액, 최근 구매일, 최근 접속일, 회원등급 혜택, 회원등급 변경등에 따라 발급될 수 있습니다. 할인쿠폰의 세부구분, 할인금액(할인율), 사용방법, 사용기한 및 제한에 대한 사항은 할인쿠폰 또는 서비스 화면에 표시됩니다. 할인쿠폰의 종류 및 내용과 발급 여부는 ${siteName}의 서비스 정책에 따라 변경될 수 있습니다.
②할인쿠폰은 현금으로 출금될 수 없으며, 할인쿠폰에 표시된 유효기간이 만료되거나 회원자격이 상실되면 소멸합니다.
③할인쿠폰은 ${siteName}에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며, 부정한 목적이나 용도로 사용할 수 없습니다. 이를 위반한 경우 ${siteName}는 할인쿠폰을 소멸시키거나 회원자격을 제한 또는 상실시킬 수 있습니다.
④회원이 부정한 방법으로  적립금 또는 할인쿠폰을 획득한 사실이 확인될 경우, 회원의 적립금 또는 할인쿠폰을 회수하고, 회원자격 상실(아이디 삭제) 및 민?형사 상의 법적 조치 등을 취할 수 있습니다.

제30조 마케팅 정보 수신 동의
${siteName} 개인정보보호법 및 정보통신망이용촉진및정보보호등에관한법률 등 관계법령에 따라 광고성정보를 전송하기 위해 수신자의 사전 수신동의를 받고 있으며, 광고성정보 수신자 의 수신동의여부를 정기적으로 확인합니다.

- 전송방법
 고객님의 모바일 App Push, 핸드폰 문자메시지(SMS), Email,카카오톡(알림톡,브랜드톡), 네이버 스마트알림,프레시솔루션등을 통해 전달될 수 있습니다.

- 전송내용
 발송되는 마케팅 정보는 수신자에게 ${siteName}과 관련하여 제공하는 혜택(포인트, 쿠폰 등) 정보, 각종 이벤트 정보 등 광고성 정보로 관련 법의 규정을 준수하여 발송됩니다. 단, 광고성 정보 이외 의무적으로 안내되어야 하는 정보성 내용은 수신동의 여부와 무관하게 제공됩니다.

- 철회안내
 고객님은 수신 동의 이후에라도 의사에 따라 동의를 철회할 수 있으며, 수신을 동의하지 않아도 회사가 제공하는 기본적인 서비스를 이용할 수 있으나, 당사의 마케팅 정보를 수신하지 못할 수 있습니다.

- 수신동의 변경
 ${siteName} 홈페이지(www.OOO.co.kr) 또는 ${siteName} 고객센터(00-0000-0000)을 통해 수신동의를 변경(동의/철회)할 수 있습니다.
...
제32조(할인쿠폰)
① 할인쿠폰은 "몰"에서 유상 또는 무상으로 발행하는 쿠폰으로 발행대상, 발행경로, 사용대상 등에 따라 구분될 수 있으며, 할인쿠폰의 세부구분, 할인금액(할인율), 사용방법, 사용기한 및 제한에 대한 사항은 할인쿠폰 또는 서비스 화면에 표시됩니다. 할인쿠폰의 종류 및 내용은 회사의 서비스 정책에 따라 변경될 수 있습니다. 할인쿠폰은 회원의 구매횟수, 구매금액, 최근 구매일, 최근 접속일, 회원등급 혜택, 회원등급 변경 등에 따라서 발급될 수 있습니다.

② 할인쿠폰은 현금으로 출금될 수 없으며, 할인쿠폰에 표시된 유효기간이 만료되거나 회원자격이 상실되면 소멸합니다.

③ 할인쿠폰은 "몰"에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며, 부정한 목적이나 용도로 사용할 수 없습니다. 이를 위반한 경우 "몰"은 할인쿠폰을 소멸시키거나 회원자격을 제한 또는 상실시킬 수 있습니다.

④ 이용자가 부정한 방법으로 적립금 또는 할인쿠폰을 획득한 사실이 확인될 경우, "몰"은 이용자의 적립금 또는 할인쿠폰을 회수하고, 회원자격 상실(아이디 삭제) 및 민 형사 상의 법적 조치 등을 취할 수 있습니다.

⑤ 회원 탈퇴 시 "몰"로부터 발급받은 "구매할인쿠폰" 중 미사용한 "구매할인쿠폰"은 즉시 소멸되며, 탈퇴 후 재가입하더라도 소멸된 "구매할인쿠폰"은 복구되지 아니합니다.

⑥ 쿠폰의 부여 및 사용 소멸에 관한 상세한 사항은 "몰"이 정한 정책에 따르며, "몰"은 sms, 알림톡, 이메일 등으로 사용/소멸 내용을 이용회원에게 안내합니다.

부 칙(시행일)
이 약관은 2000 년 00월 00일부터 시행합니다.
본 페이지는 실제 이용되는 페이지가 아닌 프론트엔드 개발자의 포트폴리오용으로 작성된 페이지입니다.`}</pre>
		</div>
	);
};
